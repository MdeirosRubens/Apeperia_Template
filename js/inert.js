(function (global, factory) {
  ...
  (function (document) {
      ...
      createClass(InertRoot, [
        ...
        },
        {
          ...
          value: function _visitNode(node) {
            ...
            if (
              index(node, _focusableElementsString) ||
    ...
    function contains(node, other) {
      return (
        other &&
        (node === other || !!(node.compareDocumentPosition(other) & 16))
      );
    }
